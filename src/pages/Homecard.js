...
import ReactLogo from './doctor.svg';

const Homecard = () => {
  return (
      <div className="container mx-auto p-4 mt-4 mb-3 md:px-12 divide-y  backdrop-blur-3xl bg-white/20 dark:text-gray-100 mx-4 rounded-lg">
        ...
        <div class="px-3 w-full lg:w-2/5">
            <div
                ...
                <p
                    ...
                    Helping you to connect to your doctors securely
                </p>
            </div>
            ...
            <div class="text-center lg:text-left">
                ...
                <a class="block visible py-4 px-8 text-xs font-semibold leading-none bg-white rounded border border-solid cursor-pointer sm:inline-block border-slate-200 text-slate-500">Login For Doctor</a>
            </div>
        </div>
            ...
            <div class="flex justify-center items-center">
                {/* <svg
                    ...
                    <polygon
                      ...
                      <img src = {ReactLogo} alt="My Happy SVG"/>
            </div>
        </div>
    </section>
    </div>
